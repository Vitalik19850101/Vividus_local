...
|#{generate(regexify'[A-Za-z0-9]{12}')}|#{generate(Internet.emailAddress)}|#{generate(Internet.password)}|(//div[contains(@class,'item--text')][1])|(//a[contains(@class,'link_small')])[1] |//input[@type='email'] |(//input[contains(@type,'password')])[1] |(//input[contains(@type,'password')])[2]|//button[contains(@class,'auth-button')]|
